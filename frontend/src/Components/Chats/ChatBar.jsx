...
const ChatBar = () => {
  ...
  useEffect(() => {
    ...
    const fetchMessages = () => {
      axios.get(`${import.meta.env.VITE_API_URL}/chat/${userId}/${receiver._id}`)
          ...
          {loading ? (
            ...
            messages.map((msg, idx) => (
              <div
                ...
                className={
                  msg.sender === userId
                    ? 'bg-blue-300 p-2 rounded-md self-end max-w-[70%]'
                    : 'bg-gray-300 p-2 rounded-md w-fit max-w-[70%]'
                }
              >
                {msg.content}
              </div>
...
//     <div className='h-screen'>
//         <div className='w-full h-18 rounded-md bg-gray-200 border-2 border-black flex items-center gap-5 px-4'>
//             <i onClick={() => navigate(-1)} className=" text-2xl fa-solid fa-arrow-left"></i>
//             <div><img className='w-12 border-2 border-black h-12 object-cover rounded-full ' src="\public\images\alesia-kazantceva-XLm6-fPwK5Q-unsplash.jpg" alt="" /></div>
//             <div className='flex flex-col '>
//                 <p className='font-semibold'>Hussnain Ali</p>
//                 <p>Online</p>
//             </div>
//         </div>
//         <div className=' flex flex-col justify-between  h-[calc(100vh-72px)] '>
//             <div className='flex flex-col gap-2 p-4 overflow-y-scroll'>
//                 <div className='bg-gray-300 p-2 rounded-md w-fit'>Hello, how are you?</div>
//                 <div className='bg-blue-300 p-2 rounded-md self-end'>I am fine, thank you!</div>
//                 <div className='bg-gray-300 p-2 rounded-md w-fit'>What about you?</div>
//                 <div className='bg-blue-300 p-2 rounded-md self-end'>I am doing great!</div>
//                 <div className='bg-gray-300 p-2 rounded-md w-fit'>Hello, how are you?</div>
//                 <div className='bg-blue-300 p-2 rounded-md self-end'>I am fine, thank you!</div>
//                 <div className='bg-gray-300 p-2 rounded-md w-fit'>What about you?</div>
//                 <div className='bg-blue-300 p-2 rounded-md self-end'>I am doing great!</div>
...
//             </div>
//             <div className='flex items-center justify-around gap-2 m-3'>
//                 <input type="text" className='w-[90%]  h-12 rounded-md border-2 border-black px-4' placeholder='Type your message...' />
//                 <i className="text-black text-3xl fa-solid fa-paper-plane"></i>
//             </div>
//         </div>
